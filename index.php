...
<html lang="en">
	<head>
		...
		<link rel="icon" href="icons/gmail.ico" type="image/x-icon">

	</head>
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://github.com/jarircse16/PHP_Email_Sender">PHP Email Bomber</a>
		</div>
	</nav>
	<div class="col-md-3"></div>
	<div class="col-md-6 well">
		<h3 class="text-primary">PHP - Email Bomb From Localhost</h3>
		...
		<div class="col-md-6">
			<form method="POST" action="send_email.php">
				...
				<div class="form-group">
					<label>Count</label>
					<input type="number" class="form-control" name="count" required="required" min="0" step="1"/>
				</div>
